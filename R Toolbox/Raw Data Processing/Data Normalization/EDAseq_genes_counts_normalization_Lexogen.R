...
setwd(paste0(master.location,"/TBI-LAB - Nanomaterials - Laura -SDR400025/"))

# dependencies
source (paste0(toolbox.path,"./R scripts/ipak.function.R"))
ibiopak(c("EDASeq", "base64enc", "preprocessCore", "openxlsx"))

#Read text file
# Load required files
load(paste0(toolbox.path,"./GeneInfo/geneInfo.Sept2018.RData"))
counts = "./Raw Counts/DB_SDR400025_201202_LEX8_B1.combined.counts.txt"
sub.reads = readLines(counts, n=1)  #why using (readLines)
...
#dir.create("./Graphene/processed_data/normalization", showWarnings = FALSE)
save(samples.data, file = "./Graphene/processed_data/normalization/Unnormalized_counts_EDAseq.Rdata")
...
save(samples.filtered, file = "./Graphene/processed_data/normalization/unnormalized_counts_geneInfo_filtered_EDAseq.Rdata")
